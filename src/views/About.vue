  ...
  <div>
    ...
    <div id="about_view">
      ...
      <ul class="contributors">
        <li>میلاد ماهار | ایده کار و داده های مهندسی عمران</li>
        <li>محمدامین زینالی | داده های مهندسی برق</li>
        <li>ادیب رضایی | داده های مهندسی کامپیوتر</li>
        <li>آرمان حاج محمدی | لوگو، فعالیت اجرایی و هماهنگی</li>
        <li>فاطمه اکبری | داده های جغرافیا</li>
        <li>سینا نائینیان | داده های مهندسی مواد</li>
        <li>محمد ناصری | داده های مهندسی مکانیک</li>
        <li>محمد رضا جعفری | داده های مهندسی صنایع</li>
        <li>امیرسجاد افشار | داده های مهندسی نفت</li>
        <li>محمد رضا پاشایی | داده های مهندسی نقشه برداری</li>
        <li>پروا شریفی | داده های مهندسی کامپیوتر</li>
        <li>زینب امینی | داده های مهندسی عمران</li>
        <li>فاطمه جباری | داده های مهندسی شیمی</li>
        <li>همایون | داده های مهندسی برق</li>
      </ul>
    </div>
  </div>
</template>
